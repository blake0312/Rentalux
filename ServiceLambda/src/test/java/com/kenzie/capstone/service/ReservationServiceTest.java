...
//
//        // WHEN
//        ReservationData response = this.reservationService.setReservationData(data);
//
//        // THEN
//        verify(reservationDao, times(1)).setReservationData(idCaptor.capture(), dataCaptor.capture());
//
...
//
//        // WHEN
//        ReservationData response = this.reservationService.getReservationData(id);
//
//        // THEN
