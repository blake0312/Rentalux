...
public class UpdateReservationData implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ReservationData reservationData = reservationService.updateReservationData(rdata.getId(), rdata.getCustomerId(), rdata.isPayed(),
